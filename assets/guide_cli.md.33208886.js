import{_ as e,c as n,o as a,a as s}from"./app.a8991bc1.js";const g='{"title":"Command Line","description":"","frontmatter":{},"headers":[{"level":2,"title":"Run File","slug":"run-file"},{"level":3,"title":"Plugin Details","slug":"plugin-details"},{"level":2,"title":"Show External","slug":"show-external"}],"relativePath":"guide/cli.md","lastUpdated":1640223497423}',t={},i=s(`<h1 id="command-line" tabindex="-1">Command Line <a class="header-anchor" href="#command-line" aria-hidden="true">#</a></h1><h2 id="run-file" tabindex="-1">Run File <a class="header-anchor" href="#run-file" aria-hidden="true">#</a></h2><div class="language-bash"><pre><code>$ esbuild-dev main.ts
...
<span class="token comment"># run main.ts with esm loader</span>
<span class="token comment"># in this mode, --cjs, --watch and --plugin are not supported.</span>
...
</code></pre></div><p>See the API <a href="./api.html#external">external</a> for more details.</p>`,12),l=[i];function o(r,d,c,p,u,h){return a(),n("div",null,l)}var f=e(t,[["render",o]]);export{g as __pageData,f as default};
