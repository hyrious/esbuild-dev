import{_ as e,c as n,o as a,a as s}from"./app.4eee2c79.js";const g='{"title":"Command Line","description":"","frontmatter":{},"headers":[{"level":2,"title":"Run File","slug":"run-file"},{"level":3,"title":"Plugin Details","slug":"plugin-details"},{"level":2,"title":"Show External","slug":"show-external"}],"relativePath":"guide/cli.md"}',t={},i=s(`<h1 id="command-line" tabindex="-1">Command Line <a class="header-anchor" href="#command-line" aria-hidden="true">#</a></h1><h2 id="run-file" tabindex="-1">Run File <a class="header-anchor" href="#run-file" aria-hidden="true">#</a></h2><div class="language-bash"><pre><code>$ esbuild-dev main.ts
